...
namespace Talent.Services.Profile.Domain.Contracts
{
    public interface IProfileService
    {
       // bool AddNewLanguage(AddLanguageViewModel language);
        Task<string> AddNewLanguages(UserLanguage language);
        Task<string> AddSkill(UserSkill skill);
      //  Task<string> AddEmployerProfileImages(IFormFile file);
        Task<string> AddNewExperience(ExperienceViewModel experience);
        Task DeleteLanguageById(string id);
        Task DeleteExperience(string id);
        Task DeleteSkill(string id);
        Task<bool> UpdateLanguage (UserLanguage language);
        Task<string> UpdateExperience(ExperienceViewModel experience);
      
        Task<bool> UpdateSkill(UserSkill skill);
        ...
        Task<UserLanguage> GetLanguageById(string Id);
